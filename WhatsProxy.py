#!/usr/bin/env python
# -*- encoding: utf-8 -*-
# Author: WhatsVPN<whatsvpnfree@gmail.com>
#         https://whatsproxy.com
# Created on 2017-9-12 18:43:38

VERSION = (0, 2)
__version__ = '.'.join(map(str, VERSION[0:2]))
__description__ = 'HTTP Proxy Server in Python'
__author__ = 'WhatsVPN'
__author_email__ = 'whatsvpnfree@gmail.com'
__homepage__ = 'https://github.com/WhatsVPN/chromium'
__license__ = 'BSD'
